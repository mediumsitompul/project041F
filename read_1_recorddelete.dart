...
import 'result_read_1_record_delete.dart';
import 'package:http/http.dart' as http;
import 'read_1_record_notfound.dart';
import 'result_read_1_record.dart';
import 'main.dart';

class Read1RecordDelete extends StatelessWidget {
  const Read1RecordDelete({super.key});
    ...
    if (datastudent.toString().isEmpty) {
      ...
      if (datastudent[0]['id'] != null) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ResultRead1RecordDelete(
                id1_: id1,
